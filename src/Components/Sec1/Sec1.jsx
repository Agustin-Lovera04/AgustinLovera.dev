...
const Sec1 = () => {
  return (
    <div className="sec1 d-flex justify-content-center align-items-center">
            <div className="col-2 text-end">
                <img src={perfil} alt="" className='perfil_img'/>
            </div>
            <div className="col-8 text-center">
                <h1 className='var-h1 text-light'>Hola! Soy  <span className='text-warning'>Agustin Lovera</span></h1>
                <h4 className='var-h4 fw-bold text-light position-relative'>Full Stack Developer</h4>
                 <svg
